...
def build_flutter_windows(version, features, skip_portable_pack):
    ...
    system2(
        f'python3 ./generate.py -f ../../{flutter_build_dir_2} -o . -e ../../{flutter_build_dir_2}/ampdesk.exe')
    os.chdir('../..')
    packer_exe = './target/release/deps/rustdesk_portable_packer.exe'
    install_exe = f'./rustdesk-{version}-install.exe'
    if os.path.exists(packer_exe):
        os.replace(packer_exe, install_exe)
    print(
