...
class MyTheme {
  ...
  static const Color accent = Color(0xFF2A2A2A); // Charcoal Black/Gray
  static const Color accent50 = Color(0x772A2A2A);
  static const Color accent80 = Color(0xAA2A2A2A);
  static const Color canvasColor = Color(0xFF212121);
  static const Color border = Color(0xFFCCCCCC);
  static const Color idColor = Color(0xFF555555); // Gray idColor
  static const Color darkGray = Color.fromARGB(255, 148, 148, 148);
  static const Color cmIdColor = Color(0xFF444444);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFF4A4A4A); // Gray button
  static const Color hoverBorder = Color(0xFF888888);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
        primary: Color(0xFF2A2A2A), secondary: accent, background: grayBg),
